...
export LIBTORCH_VARIANT=shared-with-deps
...
export PATCHELF_BIN=$(which patchelf)
...
export LIBTORCH_HOUSE_DIR=libtorch_house
export PYTORCH_FINAL_PACKAGE_DIR=/final-packages/
